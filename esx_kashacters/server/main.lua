...
local IdentifierTables = {
    ...
    {table = "es_stockmarket", column = "owner"},
    {table = "owned_properties", column = "owner"},
    {table = "houses", column = "owner"},
    {table = "inventories", column = "owner"},       
    {table = "james_motels", column = "owner"},
    {table = "houses", column = "owner"},
    {table = "methplants", column = "owner"},
    {table = "owned_properties", column = "owner"},
    ...
    {table = "playerstattoos", column = "userIdentifier"},
    {table = "donors", column = "identifier"},
    {table = "hackerlevels", column = "identifier"},
    ...
    {table = "user_keys", column = "identifier"},
    {table = "sim", column = "identifier"},  
    {table = "society_moneywash", column = "identifier"},
    {table = "users", column = "identifier"},  
    {table = "user_policearmory", column = "identifier"},   
    {table = "utk_motels_notifies", column = "identifier"}, 
